...
module RbConfig
  RUBY_VERSION.start_with?("3.3.") or
    raise "ruby lib version (3.3.7) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["MINOR"] = "3"
  CONFIG["TEENY"] = "7"
  CONFIG["PATCHLEVEL"] = "123"
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/lacum/.asdf/installs/ruby/3.3.7")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/lacum/.asdf/installs/ruby/3.3.7' '--enable-shared' '--with-ext=openssl,psych,+'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/home/lacum/.asdf/installs/ruby/3.3.7"
  ...
  CONFIG["ARFLAGS"] = "rcD "
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "gcc (GCC) 15.1.1 20250425\nCopyright (C) 2025 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  ...
  CONFIG["LDFLAGS"] = "-L. -fstack-protector-strong -rdynamic -Wl,-export-dynamic -Wl,--no-as-needed"
